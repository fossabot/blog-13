define(['eve'], function (eve) {
  ...
  var supportsTouch = ('ontouchstart' in window) || window.TouchEvent || window.DocumentTouch && document instanceof DocumentTouch
  var E = ''
  var S = ' '
  var Str = String
  var split = 'split'
  var events = 'click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel'[split](S)
  var touchMap = {
  ...
  function interHelper (bez1, bez2, justCount) {
    ...
    for (i = 0; i < n1; i++) {
      for (var j = 0; j < n2; j++) {
        ...
        var dj = dots2[j]
        var dj1 = dots2[j + 1]
        var ci = abs(di1.x - di.x) < 0.001 ? 'y' : 'x'
        var cj = abs(dj1.x - dj.x) < 0.001 ? 'y' : 'x'
  ...
  function interPathHelper (path1, path2, justCount) {
    ...
    var x1; var y1; var x2; var y2; var x1m; var y1m; var x2m; var y2m; var bez1; var bez2
    var res = justCount ? 0 : []
  ...
  elproto.drag = function (onmove, onstart, onend, move_scope, start_scope, end_scope) {
    function start (e) {
      ...
      if (supportsTouch && e.touches) {
        var i = e.touches.length; var touch
        while (i--) {
          touch = e.touches[i]
  ...
  var getLengthFactory = function (istotal, subpath) {
    return function (path, length, onlystart) {
      path = path2curve(path)
      var x; var y; var p; var l; var sp = ''; var subpaths = {}; var point
      var len = 0
      for (var i = 0, ii = path.length; i < ii; i++) {
        p = path[i]
        if (p[0] == 'M') {
  ...
  elproto.getPath = function () {
    var path
    var getPath = R._getPath[this.type]
