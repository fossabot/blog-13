    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php
                $route = ['admin.posts.index', 'admin.posts.create', 'admin.posts.edit', 'admin.categories.index', 'admin.categories.create', 'admin.categories.edit', 'admin.tags.index', 'admin.tags.create', 'admin.tags.edit']
                ?>
                <li class="nav-item has-treeview {{ set_active($route, 'menu-open') }}">
                    <a href="#" class="nav-link {{ set_active($route) }}">
