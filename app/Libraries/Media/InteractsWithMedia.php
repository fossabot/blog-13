 ...
 *
 *  @modified    5/16/20, 12:44 AM
 *  @name          InteractsWithMedia.php
 *  @author         Nur Wachid
...
{
    /** @var \App\Libraries\Media\Conversions\Conversion[] */
    public array $mediaConversions = [];

    /** @var \App\Libraries\Media\MediaCollections\MediaCollection[] */
     ...
     *
     * @throws \App\Libraries\Media\MediaCollections\Exceptions\FileCannotBeAdded
     * @return \App\Libraries\Media\MediaCollections\FileAdder
     *
     */
     ...
     *
     * @param string $collectionName
     * @param \App\Libraries\Media\MediaCollections\Models\Media[]|\Illuminate\Support\Collection $excludedMedia
     *
     * @return $this
     */
     ...
     *
     * @param \App\Libraries\Media\MediaCollections\Models\Media|int $mediaId
     *
     * @throws \App\Libraries\Media\MediaCollections\Exceptions\MediaCannotBeDeleted
     */
